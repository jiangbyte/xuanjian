...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            network::dns::network_dns_resolve,
            network::connections::network_list_connections,
            network::stats::network_interface_traffic,
            ...
            network::speed_nodes::network_speed_list_nodes,
            network::speed_nodes::network_speed_pick_node,
