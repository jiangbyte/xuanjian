...
export function buildOrchestratorSystemPrompt(
  ...
  return [
    ...
    "docker pull/compose 等长任务：terminal_run/terminal_tail 一次给足 wait_ms（如 120000）；工具在提示符/静默/截止时返回。若 still_running=true，按 suggested_next_wait_ms 加大 wait 再等，禁止无进展短间隔反复 terminal_tail。",
